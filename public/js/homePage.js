...
async function addExpense() {
  try {
    ...
    const res = await axios
      .post(
        "https://expense-tracker-nosql.onrender.com/expense/addExpense",
        {
          date: dateStr,
...
async function getAllExpenses() {
  ...
  try {
    ...
    const res = await axios.get(
      "https://expense-tracker-nosql.onrender.com/expense/getAllExpenses/1",
      { headers: { Authorization: token } }
    );
...
async function paginationBtn(e) {
  try {
    ...
    const token = localStorage.getItem("token");
    const res = await axios.get(
      `https://expense-tracker-nosql.onrender.com/expense/getAllExpenses/${pageNo}`,
      { headers: { Authorization: token } }
    );
...
async function deleteExpense(e) {
  try {
    ...
    if (e.target.classList.contains("delete")) {
      ...
      const res = await axios.get(
        `https://expense-tracker-nosql.onrender.com/expense/deleteExpense/${id}`,
        { headers: { Authorization: token } }
      );
      window.location.reload();
    }
...
async function editExpense(e) {
  try {
    ...
    if (e.target.classList.contains("edit")) {
      ...
      const res = await axios.get(
        "https://expense-tracker-nosql.onrender.com/expense/getAllExpenses",
        { headers: { Authorization: token } }
      );
        ...
        if (expense._id == id) {
          ...
          addExpenseBtn.addEventListener("click", async function update(e) {
            ...
            const res = await axios.post(
              `https://expense-tracker-nosql.onrender.com/expense/editExpense/${id}`,
              {
...
async function buyPremium(e) {
  const token = localStorage.getItem("token");
  const res = await axios.get(
    "https://expense-tracker-nosql.onrender.com/purchase/premiumMembership",
    { headers: { Authorization: token } }
  );
  var options = {
    ...
    handler: async function (response) {
      const res = await axios.post(
        "https://expense-tracker-nosql.onrender.com/purchase/updateTransactionStatus",
        {
...
async function isPremiumUser() {
  const token = localStorage.getItem("token");
  const res = await axios.get("https://expense-tracker-nosql.onrender.com/user/isPremiumUser", {
    headers: { Authorization: token },
  });
